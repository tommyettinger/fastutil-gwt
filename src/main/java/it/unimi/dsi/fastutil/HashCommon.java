...
public class HashCommon {
    ...
    /** 2<sup>20</sup> &middot; &phi;, &phi; = (&#x221A;5 &minus; 1)/2. */
    private static final int INT_PHI = 0x9E375;
    /** The reciprocal of {@link #INT_PHI} modulo 2<sup>32</sup>. */
    private static final int INV_INT_PHI = 0x43B94DD;
	 ...
	 * is slightly larger), but it's much faster. This is a variant that multiplies by a smaller constant (20 bits)
	 * to avoid precision loss on GWT, which would have much worse consequences than the slightly higher probe amount
	 * caused by using a smaller multiplier.
	 * 
	 * @param n an integer.
	 * @return a hash value obtained by mixing the bits of {@code x}.
	 * @see #invMix(int)
	 */	
	public final static int mix( final int n ) {
